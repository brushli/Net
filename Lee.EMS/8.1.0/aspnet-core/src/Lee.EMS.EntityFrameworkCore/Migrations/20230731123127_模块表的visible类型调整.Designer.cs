...
namespace Lee.EMS.Migrations
{
    ...
    [Migration("20230731123127_模块表的visible类型调整")]
    partial class 模块表的visible类型调整
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lee.EMS.BAS.Dictionary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Bas_Dictionary");
                });

            modelBuilder.Entity("Lee.EMS.BAS.DictionaryDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Bas_DictionaryDetail");
                });
            ...
            modelBuilder.Entity("Lee.EMS.SYS.Action", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Lee.EMS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Lee.EMS.Authorization.Users.User", null)
                        .WithMany("Claims")
