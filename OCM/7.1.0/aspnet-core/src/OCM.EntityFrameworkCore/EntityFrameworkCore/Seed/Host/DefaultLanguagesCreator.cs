...
namespace OCM.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly OCMDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = OCMConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OCMDbContext context)
        {
            _context = context;
        }
