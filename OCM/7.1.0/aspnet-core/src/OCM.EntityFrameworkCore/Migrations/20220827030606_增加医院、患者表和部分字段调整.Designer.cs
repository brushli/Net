...
namespace OCM.Migrations
{
    ...
    [Migration("20220827030606_增加医院、患者表和部分字段调整")]
    partial class 增加医院患者表和部分字段调整
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OCM.IH.Hospital", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OCM.IH.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OCM.SYS.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("sys_MenuItems");
                });

            modelBuilder.Entity("OCM.SYS.MenuItemInRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OCM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OCM.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OCM.SYS.MenuItemInRole", b =>
                {
                    b.HasOne("OCM.SYS.MenuItem", null)
                        .WithMany("MenuItemInRoles")
