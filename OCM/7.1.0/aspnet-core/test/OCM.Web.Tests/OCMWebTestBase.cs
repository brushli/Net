...
{
    public abstract class OCMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OCMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OCMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OCMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OCMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OCMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OCMDbContext, Task<T>> func)
        {
            T result;
